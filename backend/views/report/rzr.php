        ...
        'columns' => [
            ...
            [
              ...
              'value' => function($data) {
              	   ...
              	   return Html::a(Yii::t('app', ' {modelClass}', ['modelClass' => 'View',]), ['report/detailed-view', ['id' => $data['id'],$data['type']]], ['class' => 'btn btn-success popupModal']);
              },
              'format' => 'raw'
            ],    
/*            [
                ...
                'value' => function ($model) {
                    ...
                    if($model['type'] == 'BUY_VOUCHER'){
                        
                        
                        return Html::a(Yii::t('app', ' {modelClass}', ['modelClass' => 'Refund',]), ['report/refund-request', ['id' => $model['id'],$model['type']]], ['class' => 'btn btn-success popupModal']);
