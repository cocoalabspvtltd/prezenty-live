...
class RedeemController extends Controller
{
    ...
    public function actionGenerateOtp($mobile) {
      ...
      ->one();
      $from = ['email'=>'app.cocoalabs@gmail.com'];
      $to = ['email'=>$user->email];
      // $to = ['email'=>'jinokt34@gmail.com'];
      $subject = 'Event App (OTP)';
      $message = $otp.' is the OTP for the verification process to redeem the voucher. Do not share this with anyone.';
