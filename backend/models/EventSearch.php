...
class EventSearch extends Event
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'date', 'time', 'image_url', 'music_file_url', 'created_at', 'modified_at','from_date','to_date'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'title', $this->title])
            ...
            ->andFilterWhere(['like', 'music_file_url', $this->music_file_url]);
        ...
        if($this->date){
            $query->andwhere(['DATE(date)'=>date('Y-m-d',strtotime($this->date))]);            
        }
