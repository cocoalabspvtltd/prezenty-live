...
<body>
  ...
  <table style="width:100%" >
    <tbody>
  <tr>
    <th style="text-align: left;"><b>Daily Event Summary</b></th>
...
<table>
  <tr>
    <p>Dear <?php echo $mailData[0]['name']; ?>,</p>
    <p>
    Following are the payment summary for the day <?php echo $mailData[0]['e_date']; ?> in event <?php echo $mailData[0]['e_name']; ?></p>
