...
class ProductController extends ActiveController
{
    ...
    {
        $model = Product::find()->select(['pk_int_id', 'vchr_product_name','p_sku_id','p_price_min','p_price_max','p_image','p_terms_and_conditions','vchr_product_desc'])->where(['pk_int_id' => $id])->One();
        $baseUrl = Yii::$app->params['base_path_products_images'];  
        $ret = [
                    'baseUrl' => $baseUrl,
                    'statusCode' => 200,
